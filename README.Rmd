...
The `{pollspain}` package also provides **more advanced users with useful functions** to preprocess and analyze electoral data—even their own data, as long as it is provided in a proper format.
